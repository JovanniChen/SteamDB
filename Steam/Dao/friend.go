...
func (d *Dao) SetPrivacy() error {
	...
	params := Param.Params{}
	params.SetString("sessionid", sessionID)
	// {"PrivacyProfile":3,"PrivacyInventory":3,"PrivacyInventoryGifts":3,"PrivacyOwnedGames":3,"PrivacyPlaytime":3,"PrivacyFriendsList":3}
...
func (d *Dao) SetPublicPrivacy() error {
	if d.GetLoginCookies()["steamcommunity.com"] == nil {
		return errors.New("steamcommunity.com cookie not found")
	}
